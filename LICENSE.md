...
<a name="acceptation-acquise"></a>3.1 L'acceptation par le Licencié des termes du Contrat est réputée acquise du fait du premier des faits suivants:
...
<a name="etendue"></a>Article 5 \- ETENDUE DES DROITS CONCEDES
----------------------------------------
...
#### <a name="compatibilite"></a>5.3.4 COMPATIBILITE AVEC D'AUTRES LICENCES
...
<a name="responsabilite"></a>Article 8 \- RESPONSABILITE
---------------------------
...
<a name="bonne-foi"></a>9.2 Le Concédant déclare de bonne foi être en droit de concéder l'ensemble des droits attachés au Logiciel (comprenant notamment les droits visés à l'article [5](#etendue)).
...
<a name="footnote1"></a>1 CeCILL est pour Ce(a) C(nrs) I(nria) L(ogiciel) L(ibre)
